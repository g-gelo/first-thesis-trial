<template>
  ...
  <div v-if="showUserTable">
    <div class="mt-4 flex items-center justify-center space-x-4 ma-3">
      <div
    ...
    <div class="overflow-x-auto">
      ...
      >
        <thead
          class="bg-green-800 shadow-md rounded-lg overflow-hidden p-4 text-white"
        >
          <tr>
            ...
            >
              <div class="flex items-center space-x-2">
                <select
                  ...
                  @change="confirmUpdateUserRole(user.id, $event.target.value)"
                >
                  <option
                    value="SUPERADMIN"
