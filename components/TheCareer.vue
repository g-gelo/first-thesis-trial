<template>
  <div class="flex flex-col">
    <div
      v-if="data?.user?.role == `SUPERADMIN` || data?.user?.role == `ADMIN`"
      class="relative"
    >
      <button
    ...
    <div class="mt-10">
      ...
      >
        <div
          class="h-64 flex max-w-md w-full h-full shadow-lg rounded-xl"
          v-if="career.isArchive == false"
        >
                  ...
                  <button
                    ...
                    @click="
                      ($event) => {
                        ...
                        editedCareer.title = career.title;
                        editedCareer.description = career.description;
                        editedCareer.date = career.date;
                        editedCareer.location = career.location;
                        editedCareer.isArchive = career.isArchive;
      ...
      <div class="bg-white shadow-lg rounded-lg p-6 max-w-md w-full">
        ...
        <div>
          ...
          <div class="seminar-info ma-2">
            <v-icon class="ml-6 icon-small">fa-regular fa-calendar-days</v-icon>
            <span class="ml-3 info-value info-small">{{
              detailedCareer.date
            }}</span>
          </div>
          <div class="ma-2 seminar-info">
            <v-icon start class="icon-small">fa-solid fa-location-dot</v-icon>
            <span class="info-value info-small pa-0">{{
