<template>
  <div class="flex flex-col">
    ...
    <div class="mt-10">
      <div v-for="meeting in seminars" :key="meeting.id" class="mb-6 bg-white">
        <div
          class="h-64 flex shadow-lg rounded-xl"
          v-if="meeting.isArchive == false"
        >
          ...
          >
            ...
            <div class="ma-2 seminar-info">
              ...
              <span class="info-value info-small">{{ meeting.location }}</span>
            </div>
            <div class="ma-2 seminar-info">
