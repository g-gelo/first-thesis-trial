    ...
    <v-container>
      <div class="hierarchy-text card">
        ...
        <p class="subtitle">
          ...
          announcements. Get ready to experience an all-new offline mobile
          application that can still help you whenever you need help. Empowering
          you with knowledge and opportunities for growth.
        </p>
      </div>
    </v-container>
    <TheTitle
